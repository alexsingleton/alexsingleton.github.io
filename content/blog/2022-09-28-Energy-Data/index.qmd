...
elec_lsoa_dz <- read_parquet("./parquet/elec_lsoa_dz.parquet")
gas_lsoa_dz <- read_parquet("./parquet/gas_lsoa_dz.parquet")
income <- read_parquet("./parquet/income.parquet")
...
write_parquet(elec_lsoa_dz, sink = "./parquet/elec_lsoa_dz.parquet")
write_parquet(gas_lsoa_dz, sink = "./parquet/gas_lsoa_dz.parquet")
```
...
```{r echo=FALSE, eval=FALSE}
#Save file for later use
write_parquet(income, sink = "./parquet/income.parquet")
